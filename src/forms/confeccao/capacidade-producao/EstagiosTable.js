...
export default class EstagiosTable extends React.Component {
    ...
    render() {
        ...
        return (
            <BootstrapTable ref='table-estagios' data={estagios} pagination={true} options={options} striped={true} hover={true} cellEdit={cellEditProp} keyBoardNav={keyBoardNav} footerData={footerData} footer>

                <TableHeaderColumn dataField='estagio' dataSort isKey={true} filter={{ type: 'TextFilter', placeholder: 'Código' }} width='150'>Código</TableHeaderColumn>

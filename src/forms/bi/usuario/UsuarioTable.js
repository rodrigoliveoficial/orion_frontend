    ...
    render() {
        ...
        return (
            <BootstrapTable ref='usuarios-table' data={usuarios} pagination={true} options={options} striped={true} hover={true} keyBoardNav>
                ...
                <TableHeaderColumn dataField='nome' filter={{ type: 'TextFilter', placeholder: 'Nome' }} dataSort>Nome</TableHeaderColumn>
                <TableHeaderColumn dataField='usuario' filter={{ type: 'TextFilter', placeholder: 'Usuário' }} dataSort>Usuário</TableHeaderColumn>
